...
import { FaEnvelope, FaPhone, FaMapMarkerAlt, FaPaperPlane, FaCheck, FaClock, FaBookOpen } from 'react-icons/fa';
...
export default function ContactPage() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setErrors({
        ...errors,
        submit: 'There was a problem sending your message. Please try again later.'
      });
    } finally {
  ...
  <div 
    ...
    style={{
      backgroundImage: "url('https://images.unsplash.com/photo-1589998059171-988d887df646')",
  ...
  ></div>
      ...
      <main className="flex-grow relative z-10 px-4 sm:px-6 lg:px-8 py-12 max-w-6xl mx-auto w-full">
        ...
        <div className="text-center max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 pt-16 pb-12">
          <h1 className="text-5xl font-bold text-gray-900 mb-4 font-serif">Contact The MadCoders</h1>
        ...
        <div className="flex flex-col lg:flex-row gap-8 justify-between">
                ...
                <div className="grid grid-cols-1 gap-6">
                  <div>
                    ...
                    <input
                      ...
                      className={`w-full px-4 py-3 rounded-lg border ${errors.name ? 'border-red-300' : 'border-gray-300'} focus:border-indigo-600 focus:ring-2 focus:ring-indigo-100 transition bg-white bg-opacity-70`}
                  ...
                  <div>
                    ...
                    <input
                      ...
                      onChange={handleChange}
                      className={`w-full px-4 py-3 rounded-lg border ${errors.email ? 'border-red-300' : 'border-gray-300'} focus:border-indigo-600 focus:ring-2 focus:ring-indigo-100 transition bg-white bg-opacity-70`}
                  ...
                  <div>
                    ...
                    <input
                      ...
                      onChange={handleChange}
                      className={`w-full px-4 py-3 rounded-lg border ${errors.subject ? 'border-red-300' : 'border-gray-300'} focus:border-indigo-600 focus:ring-2 focus:ring-indigo-100 transition bg-white bg-opacity-70`}
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      onChange={handleChange}
                      className={`w-full px-4 py-3 rounded-lg border ${errors.message ? 'border-red-300' : 'border-gray-300'} focus:border-indigo-600 focus:ring-2 focus:ring-indigo-100 transition bg-white bg-opacity-70`}
                  ...
                  <div className="pt-2">
                    <button
                      ...
                      className={`w-full px-6 py-4 border border-transparent text-base font-medium rounded-lg shadow-sm text-white bg-indigo-600 hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 transition-colors ${isSubmitting ? 'opacity-80 cursor-not-allowed' : ''}`}
                    >
                      {isSubmitting ? (
                        <>
          ...
          <div className="lg:w-1/1">
            <div className="bg-white bg-opacity-90 backdrop-blur-sm p-8 rounded-2xl shadow-xl border border-gray-100 h-full">
              <h2 className="text-2xl font-bold text-gray-900 mb-8 font-serif">Our Beirut Location</h2>
              ...
              <div className="mt-8 p-4 bg-blue-50 rounded-lg border-l-4 border-blue-400">
                <p className="italic text-blue-800">"A bookshop is not just about selling books. It's about fostering the love of reading in Beirut's vibrant community."</p>
              </div>
            </div>
          </div>
        </div>
